...
def rec_plot_info(x, y1, color_start, name_list, i, axes, identifier_name, metric, goal, range_str, axis_start, axis_end):
    """
    ...
    if goal == 'joint':
        axes.set_xlim(axis_start, axis_end)
...
def rec_line(identifier, axis_start, axis_end, goal='triangle', metric='f1', range_='00_10'):
        ...
        if range_ == '00_10':
            ...
            if ((margin_test_for_identifier[i]) > 30) & ((margin_test_for_identifier[i]) <= 40):
                rec_plot_info(x, y1, 0.4, name_list, i, axes, identifier_name, 
                              metric, goal, '30 <= KL(P`_0 || P_1) <= 40', axis_start, axis_end)
        
        elif range_ == '40_50':
            if ((margin_test_for_identifier[i]) > 40) & ((margin_test_for_identifier[i]) <= 50):
                rec_plot_info(x, y1, 0, name_list, i, axes, identifier_name, 
                              metric, goal, '40 <= KL(P`_0 || P_1) <= 50', axis_start, axis_end)

        elif range_ == '50_00':
            if (margin_test_for_identifier[i]) > 50:
                rec_plot_info(x, y1, 1.3, name_list, i, axes, identifier_name, 
                              metric, goal, 'KL(P`_0 || P_1) >= 50', axis_start, axis_end)


def show_division(identifier, axis_start, axis_end, metric='f1'):
    rec_line(identifier, axis_start, axis_end, metric=metric, range_='00_10', goal='division')
    rec_line(identifier, axis_start, axis_end, metric=metric, range_='10_20', goal='division')
    rec_line(identifier, axis_start, axis_end, metric=metric, range_='20_30', goal='division')
    rec_line(identifier, axis_start, axis_end, metric=metric, range_='30_40', goal='division')
    rec_line(identifier, axis_start, axis_end, metric=metric, range_='40_50', goal='division')
    rec_line(identifier, axis_start, axis_end, metric=metric, range_='50_00', goal='division')
    

def show_triangle(identifier, axis_start, axis_end, metric='f1'):
    rec_line(identifier, axis_start, axis_end, metric=metric, range_='00_10')
    rec_line(identifier, axis_start, axis_end, metric=metric, range_='10_20')
    rec_line(identifier, axis_start, axis_end, metric=metric, range_='20_30')
    rec_line(identifier, axis_start, axis_end, metric=metric, range_='30_40')
    rec_line(identifier, axis_start, axis_end, metric=metric, range_='40_50')
    rec_line(identifier, axis_start, axis_end, metric=metric, range_='50_00')